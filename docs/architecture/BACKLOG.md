...
| 4 | Retrain decision tree on production split (2008-2020) | Session 28 | Tree currently trained on 2008-2018 only. Should match LightGBM's training window (TRAIN_CUTOFF=2020 after session 39). Rules may change. |
