...
- **Trains** LightGBM models on 1y/3y/5y return horizons using ~59K company-year observations across 341 base columns (Phase B pipeline complete; Phase C scoring overlay pending)
