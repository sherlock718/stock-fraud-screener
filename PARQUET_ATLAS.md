...
| `data/macro.parquet` | `pipeline/step4_enrich_macro.py` | `pipeline/step5_compute_features.py` | Created fresh each run | ticker, fiscal_year, gdp_growth, unemployment, fed_funds_rate, cpi_yoy, spread_10y2y, macro_asof_date | (ticker, fiscal_year) | intermediate |
