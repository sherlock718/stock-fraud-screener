...
| `step5_compute_features.py` | Feature computation | Temporal leakage, label leakage, rank leakage, formula errors | No forward columns used, rank within fiscal_year, coverage checks | `tests/pipeline/test_step5_compute_features.py` | P0 | 28 tests + 1 xfail (leakage, formulas, winsorize, shape, rolling, sdiv) | ✅ covered |
