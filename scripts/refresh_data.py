...
Usage:
    python3 scripts/refresh_data.py --mode quick
    python3 scripts/refresh_data.py --mode prices
    python3 scripts/refresh_data.py --mode full
    python3 scripts/refresh_data.py status
"""
