...
Usage:
    python3 scripts/run_phase_checks.py            # runs Phase A + B
    python3 scripts/run_phase_checks.py --phase A  # Phase A only
    python3 scripts/run_phase_checks.py --phase B  # Phase B only
    python3 scripts/run_phase_checks.py --phase C  # Phase C only (requires trained models)
    python3 scripts/run_phase_checks.py --phase AB # Phase A + B
    python3 scripts/run_phase_checks.py --strict   # exit 1 on any FAIL or WARN
