...
Usage:
    python3 scripts/run_dataset_enrichments.py                # run all steps
...
STEPS = [
    {
        ...
        "cmd": ["scripts/fix_dataset_quality.py"],
        "skip_flag": None,
    },
    {
    ...
    },
    {
        ...
        "cmd": ["scripts/mark_survivorship.py", "--fix"],
        "skip_flag": "skip_survivorship",
    },
    {
        "name": "Quarterly feature enrichment",
        "cmd": ["scripts/enrich_quarterly_features.py", "--fix"],
        "skip_flag": "skip_quarterly",
    },
    {
        "name": "Feature imputation",
        "cmd": ["scripts/impute_features.py"],
        "skip_flag": None,
    },
    {
        "name": "Fraud labels",
    ...
    },
    {
        ...
        "cmd": ["scripts/validate_feature_contract.py"],
        "skip_flag": None,
    },
]
