...
Usage:
  ...
  python scripts/workflows/run_pipeline.py build --limit 200  # Test run (200 companies)
  python scripts/workflows/run_pipeline.py build --step 2     # Resume from step 2
  python scripts/workflows/run_pipeline.py features           # Recompute features only (step 5, no API)
  python scripts/workflows/run_pipeline.py enrich-prices      # Re-run price enrichment (step 3)
  python scripts/workflows/run_pipeline.py enrich-macro       # Re-run macro enrichment (step 4)
  python scripts/workflows/run_pipeline.py clean              # Re-run clean (step 6)
  python scripts/workflows/run_pipeline.py status             # Show dataset stats
