...
Usage:
  python3 scripts/run_pipeline_kr.py build              # full build
  python3 scripts/run_pipeline_kr.py build --step 2     # resume from step 2
  python3 scripts/run_pipeline_kr.py build --limit 50   # test run
  python3 scripts/run_pipeline_kr.py status             # check file state
"""
...
def main():
    ...
    if args.cmd == 'status' or args.cmd is None:
        ...
        #   python3 scripts/run_pipeline_kr.py build --step 1   (fetches KR tickers + snapshots)
        ...
        if args.step > 2:
            ...
            print('        python3 scripts/run_pipeline.py build --step 3')
            print()
